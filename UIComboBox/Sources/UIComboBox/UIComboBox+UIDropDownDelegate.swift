//
//  UIComboBox+UIDropDownDelegate.swift
//  Pods
//
...
extension UIComboBox: UIDropDownDelegate {
    public func numberOfRows(in dropDown: UIDropDown) -> Int {
        comboBoxDataSource?.numberOfItems?(in: self) ?? 0
    }
    
    public func dropDown(_ dropDown: UIDropDown, objectValueForItemAt index: Int) -> Any? {
        comboBoxDataSource?.comboBox?(self, objectValueForItemAt: index)
    }
    
    public func dropDown(_ dropDown: UIDropDown, didSelectRowAt indexPath: IndexPath) {
    ...
    public func dropDown(_ dropDown: UIDropDown, cellProvider: UITableViewCellProvider, cellForRowAt position: Int) -> UITableViewCell {
    ...
    public func dropDown(_ dropDown: UIDropDown, heightForRowAt position: Int) -> CGFloat {
